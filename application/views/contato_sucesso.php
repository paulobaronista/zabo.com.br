...
<div id="jardins" class="jardins">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 text-center">
                <h2>Jardins.</h2>
                <p>uma síntese do que São Paulo tem<br>
                    <span>de mais charmoso e fascinante.</span></p>
...
<div class="lancamentos-info">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 text-center">
                <h2>VOCÊ MERECE O MELHOR.<br>
                    VOCÊ MERECE UM ZABO.</h2>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
                <div class="hidden-xs col-sm-4 col-md-4">
                    <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/localizacao.png" alt="Localização">
                </div>
                <div class="hidden-xs col-xs-4 col-sm-4 col-md-4">
                    <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/arquitetura.png" alt="Arquitetura">
                </div>
                <div class="hidden-xs col-xs-4 col-sm-4 col-md-4">
                    <img class="img-responsive center-block" src="<?= base_url(); ?>assets/images/construcao.png" alt="Construção">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 text-center">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 mb-20">
                ...
                <p>Todos os nossos
                    empreendimentos são
                    planejados para oferecer
                    absoluta funcionalidade
                    em todos os espaços, onde prevalecem sempre
...
<script>
    gtag('event', 'conversion', {
        'send_to': 'AW-699541115/APH6CPv6q7EBEPvMyM0C'
    });
</script>